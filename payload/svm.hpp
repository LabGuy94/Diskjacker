...
typedef struct _VMCB_CONTROL_AREA
{
    ...
    UINT32 TrLimit;                     // +0x094
    UINT64 TrBase;                      // +0x098
    UINT8  Reserved5[0x0cb - 0x0a0];    // +0x0a0
    UINT8  Cpl;                         // +0x0cb
    UINT32 Reserved6;                   // +0x0cc
    UINT64 Efer;                        // +0x0d0
    UINT8  Reserved7[0x148 - 0x0d8];    // +0x0d8
    UINT64 Cr4;                         // +0x148
    UINT64 Cr3;                         // +0x150
    UINT64 Cr0;                         // +0x158
    UINT64 Dr7;                         // +0x160
    ...
    UINT64 Rflags;                      // +0x170
    UINT64 Rip;                         // +0x178
    UINT8  Reserved8[0x1d8 - 0x180];    // +0x180
    UINT64 Rsp;                         // +0x1d8
    UINT8  Reserved9[0x1f8 - 0x1e0];    // +0x1e0
    UINT64 Rax;                         // +0x1f8
    UINT64 Star;                        // +0x200
    UINT64 LStar;                       // +0x208
    UINT64 CStar;                       // +0x210
    ...
    UINT64 SysenterEip;                 // +0x238
    UINT64 Cr2;                         // +0x240
    UINT8  Reserved10[0x268 - 0x248];   // +0x248
    UINT64 GPat;                        // +0x268
    UINT64 DbgCtl;                      // +0x270
    UINT64 BrFrom;                      // +0x278
    UINT64 BrTo;                        // +0x280
